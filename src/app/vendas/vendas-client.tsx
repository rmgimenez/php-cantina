...
export default function VendasClient() {
  ...
  const [formaPagamento, setFormaPagamento] = useState<'conta' | 'dinheiro' | 'cartao' | 'pix'>(
    'conta'
  );
  ...
  const buscarClientes = async (tipo: 'aluno' | 'funcionario', nome: string) => {
  ...
  // Atualiza posição do dropdown em relação ao campo de busca
  const updateDropdownRect = () => {
    const el = buscaWrapperRef.current;
    if (!el) return;
        ...
        <div className='col-md-6'>
            ...
            <div className='card-body'>
              ...
              <div className='mb-3'>
                <div className='btn-group w-100' role='group'>
                  ...
                  />
                  <label className='btn btn-outline-primary' htmlFor='cliente-aluno'>
                  ...
                  />
                  <label className='btn btn-outline-primary' htmlFor='cliente-funcionario'>
                  ...
                  />
                  <label className='btn btn-outline-success' htmlFor='cliente-dinheiro'>
              ...
              {cliente.tipo !== 'dinheiro' && (
                <div className='mb-3 position-relative' ref={buscaWrapperRef}>
                  {cliente.nome ? (
                    <div className='d-flex align-items-center'>
                      ...
                      <div className='flex-grow-1'>{cliente.nome}</div>
                    ...
                    // input de busca quando nenhum cliente está selecionado
                    <input
                      type='text'
                      className='form-control'
                      value={buscarCliente}
          ...
          <div className='card mb-3'>
            <div className='card-header d-flex justify-content-between align-items-center'>
              ...
              {carrinho.length > 0 && (
                <button className='btn btn-sm btn-outline-danger' onClick={limparVenda}>
                  <FaTrash />
                </button>
              )}
            </div>
            <div className='card-body'>
              {carrinho.length === 0 ? (
                <p className='text-muted text-center'>Nenhum produto adicionado</p>
              ) : (
                  ...
                  {carrinho.map((item) => (
                    ...
                    >
                      <div className='flex-grow-1'>
                        ...
                        <br />
                        <small>R$ {parseFloat(item.produto.preco).toFixed(2)} cada</small>
                      </div>
                      <div className='d-flex align-items-center'>
                        <button
                        ...
                        <span className='ms-2 fw-bold'>R$ {item.subtotal.toFixed(2)}</span>
                        <button
              ...
              <div className='card-body'>
                ...
                {formaPagamento === 'dinheiro' && (
                  <div className='mb-3'>
                    ...
                    />
                    {valorTroco > 0 && (
                      <small className='text-success'>Troco: R$ {valorTroco.toFixed(2)}</small>
                    )}
                  </div>
                )}
